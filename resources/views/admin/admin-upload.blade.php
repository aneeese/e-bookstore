...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto ms-4 mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link pe-4 active" href="/admin-upload">Upload</a>
          </li>
          <li class="nav-item">
    ...
    <form class="row g-3 form-cust" action="{{ route('sample.validateBookAdmin') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="col-md-6">
        <label for="inputEmail4" class="form-label">Book title</label>
        <input type="text" class="form-control" name="title" id="inputEmail4" placeholder="Title" required>
      </div>
      <div class="col">
        <div class="col-md-4">
